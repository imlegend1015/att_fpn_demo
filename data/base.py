...
class Base(torch.utils.data.dataset.Dataset):
    ...
    def from_name(name: str) -> Type['Base']:
        if name == 'voc2007':
            from data.voc2007 import VOC2007
            return VOC2007
        elif name == 'coco2017':
            from data.coco2017 import COCO2017
            return COCO2017
        elif name == 'voc2007-cat-dog':
            from data.voc2007_cat_dog import VOC2007CatDog
            return VOC2007CatDog
        elif name == 'coco2017-person':
            from data.coco2017_person import COCO2017Person
            return COCO2017Person
        elif name == 'coco2017-car':
            from data.coco2017_car import COCO2017Car
            return COCO2017Car
        elif name == 'coco2017-animal':
            from data.coco2017_animal import COCO2017Animal
